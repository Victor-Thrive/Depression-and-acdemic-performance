...
3.  Install the required R packages (rub this in Rstudio or Positron)
...
├── scripts/            # R scripts
│   ├── 01-data-cleaning.R  # Data cleaning script
│   ├── 02-EFA.R            # Exploratory Factor Analysis script
│   └── 03-model.R          # Model building script (pending)
├── README.md           # Project documentation
└── outputs/            # Generated outputs (e.g., cleaned datasets, results)
```
